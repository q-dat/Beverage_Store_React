...
export const getProducts = async (): Promise<Products[]> => {
  try {
    const response = await axios.get<Products[]>(API_URL);
    return response.data;
  } catch (error) {
    console.error("Error fetching products: ", error);
...
export const getProductDetail = async (productId: string): Promise<Products> => {
  try {
...
export const createProduct = async (productData: ProductData): Promise<Products> => {
  try {
...
export const getSaleProducts = async (): Promise<Products[]> => {
  try {
    const response = await axios.get<Products[]>(SALE_URL);
    return response.data;
  } catch (error) {
...
export const getCatalogs = async (): Promise<Catalogs[]> => {
  try {
    const response = await axios.get<Catalogs[]>(CATALOG_URL);
    return response.data;
  } catch (error) {
...
export const createCatalog = async (catalogData: CatalogData): Promise<Catalogs> => {
  try {
...
export const getCatalog = async (categoryId: string): Promise<Catalogs> => {
  try {
...
export const getProductsByCatalog = async (idCatalog: string): Promise<Products[]> => {
  try {
    const response = await axios.get<Products[]>(`${API_URL}/catalog/${idCatalog}`);
    return response.data;
  } catch (error) {
...
export const searchProducts = async (name: string): Promise<Products[]> => {
  try {
    const response = await axios.get<Products[]>(`${API_URL}/search/${name}`);
    return response.data;
  } catch (error) {
